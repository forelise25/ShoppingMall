...
<head>
	...
	<script language="javascript" src="../common/global.js"></script>  <!--어디서나 쓸 JS-->
	<script language="javascript"> //이 PHP파일 안에서만 쓰일 자바스크립트는 이 안에서만 해줘도 되잖아
		function send(){
...
<table marginWidth='0' marginheight='0' leftmargin='0' topmargin='0'>
	<tr width='396' height='51' >
		<td>
			<p><img src="../img/member_title3.gif" width="390" height="61" border="0"></img></p>
		</td>
	</tr>
	<?
	...
	<tr>
		<td>
			<table border='0' cellpadding='4' width='70%' align='center'>
				<tr>
					<td width='296' align='center'> 
						<p align='left'>선택하신<br> ID : <b><?=$id?></b>는 회원 ID로 사용하실 수 있습니다.</p>
					</td>
				</tr>
				<tr>
					<td width ='296' align='center' >
						<p align = 'center'>
							<a href= "javascript:form_send('<?=$id?>')"><img src="../img/member_button3.gif" width = '88'	height='26' border='0'></img>
						</p>
					</td>
				</tr>
		<?
		...
		?>
				<tr>
					<td width='396' height= '34'>
						<p align = 'center'>
							<a href= "javascript:window.close()"><img src="../img/member_close_button.gif" width = '88'	height='26' border='0'></img></a>
						</p>
					</td>
				</tr>
			</table>
