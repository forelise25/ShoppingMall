<?
	...
	if(!isset($_SESSION['p_id']) || !isset($_SESSION['p_name'])){
		err_msg("로그인 정보가 없습니ㅏ. 다시 로그인 해주세요.");
	}
	...
	$query = "update member set passwd = '$passwd', name='$name', email='$email', phone='$phone', mobile='$hphone', zipcode='$zipcode', address1='$address1', address2 = '$address2' where id= '$_SESSION[p_id]'";
