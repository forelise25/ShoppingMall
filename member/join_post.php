<?
	...
	if($total_num){
		...
		$query1 = "insert into member(id, passwd, email, name, jnumber, phone, mobile, zipcode, address1, address2, reg_date) values( '$id', '$passwd','$email','$name','$jnumber','$phone','$hphone','$zipcode','$address1','$address2',now())";
