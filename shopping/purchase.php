...
<table width = "938" height="77" cellspacing = "0" cellpadding = "0" style='border-width:1; border-style:solid;' border="0">
	<tr>
		...
		<td width="728" height="576" valign='top' style="margin-left:20px"> 
			...
			<form name='purchase'method='post' action='purchase_post.php'>
				<table width = "95%" cellspacing = "0" cellpadding = "0" border="0">
					...
					<td align='center'class='line2'>판매가격</td>
					<td width='1' class='line2'><img src="../img/line1.gif" width='1' height='23'></td>

					<td align='center'class='line2'>수량</td>
					<td width='1' class='line2'><img src="../img/line1.gif" width='1' height='23'></td>
					
					<td align='center'class='line2'>합계</td>
					<?
					if($from=='detail'){ //1개만 한다
						$query = "select * from products p, products_cart c where user_sid = '$_COOKIE[p_sid]' and p.num = c.product_fk order by c.cart_id  desc limit 0,1";
					}else if($from=='basket'){
						$query = "select * from products p, products_cart c where user_sid = '$_COOKIE[p_sid]' and p.num = c.product_fk order by c.cart_id desc";
					}
					...
					for($i=0;$rows=mysql_fetch_array($result);$i++){  //rows는 내가산 물건의 조인한 테이블
					...
					?>
						...
						<table width = "95%" cellspacing = "0" cellpadding = "0" border="0">
							<tr bgcolor='#ebedd3'>	
								...
								<td width='30%'><strong>총 주문금액 : 
								<font color='AE'>
								<?=$last_cost?> 원</font><strong></td>
							</tr>
						</table>
						<table width = "95%" cellspacing = "0" cellpadding = "0" border="0">
							<tr bgcolor="#cccccc">
						...
						<table width = "88%" cellspacing = "0" cellpadding = "0" border="0">
							...
							<tr>
								...
								<td	class='line'>
									<input type='text' name='buyer_phone01' value="<?=$aphone[0]?>" class='input3' size='3'>-
									<input type='text' name='buyer_phone02' value="<?=$aphone[1]?>" class='input3' size='4'>-
									<input type='text' name='buyer_phone03' value="<?=$aphone[2]?>" class='input3' size='4'>
								</td>
							</tr>
							<tr>
								<td	width='14' class='line'></td>
								...
								<td	class='line'>
									<input type='text' name='buyer_hphone01' value="<?=$ahphone[0]?>" class='input3' size='3'>-
									<input type='text' name='buyer_hphone02' value="<?=$ahphone[1]?>" class='input3' size='4'>-
									<input type='text' name='buyer_hphone03' value="<?=$ahphone[2]?>" class='input3' size='4'>
								</td>
							</tr>
							<tr>
								<td	width='14' class='line'></td>
						...
						<table width = "95%" cellspacing = "0" cellpadding = "0" border="0">
							...
							<tr>
								...
								<td	width='100' class='line'>전화번호</td>
								<td	class='line'>
									<input type='text' name='recipient_phone01' class='input3' size='3'>-
									<input type='text' name='recipient_phone02' class='input3' size='4'>-
									<input type='text' name='recipient_phone03' class='input3' size='4'>
								</td>
							</tr>
							<tr>
								<td	width='14' class='line'></td>
								<td	width='100' class='line'>휴대전화</td>
								<td	class='line'>
									<input type='text' name='recipient_hphone01' class='input3' size='3'>-
									<input type='text' name='recipient_hphone02' class='input3' size='4'>-
									<input type='text' name='recipient_hphone03' class='input3' size='4'>
								</td>
							</tr>
						</table>
