		...
		<td width="728" height="576" valign='top' style="margin-left:5px;"> 
			...
			<table width = "100%" cellspacing = "0" cellpadding = "0" border="0">
				<tr>
					...
					<td width='24' bgcolor='#e1e1e1'><strong>카테고리</strong>
					<?
			...
			<table width = "100%" cellspacing = "0" cellpadding = "0" border="0">
				<tr bgcolor='#cccccc'>
					...
					<td colspan = '2' class='line2' align='center'>상품명</td>
					<td width='1'>
						<img src="../img/line1.gif" width='1' height='23'>
					</td>

					<td width='90' class='line2' align='center'>생산지</td>
					<td width='1'>
						<img src="../img/line1.gif" width='1' height='23'>
					</td>
					<td width='120' class='line2' align='center'>가격/포인트</td>
					<td width='1'>
						<img src="../img/line1.gif" width='1' height='23'>
					</td>
				</tr>
						...
						<tr>
							...
							<td align = 'center' class='line'>
								<table border='0' cellspacing='0' cellpadding='0'>
									<tr>	
										<td>
											<img src="../img/icon3.gif" width='11'height='11'>								<font color="#955275"><s><?=number_format($rows7[cust_price])?> 원</s></font>
										</td>
									</tr>
									<tr>	
										<td>
											<img src="../img/icon3.gif" width='11'height='11'>								<font color="#955275"><?=number_format($rows7[price])?> 원</font>
										</td>
									</tr>
									<tr>	
										<td>
											<img src="../img/icon4.gif" width='11'height='11'>								<?=number_format($rows7[mileage])?> POINT
										</td>
									</tr>
								</table>
							</td>
			...
			<table width = "100%" cellspacing = "0" cellpadding = "0" border="0">
				<tr>
					...
					<td align='center'>
					<?
						$url='sublist.php?l_code=$l_code&s_code=$s_code';
