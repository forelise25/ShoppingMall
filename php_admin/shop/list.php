...
<?						if($rows3[option2_chk]=='Y') {
							echo("<font color='red'>등록중</font>");		
							echo("<a href='delete1.php?p_num=$rows3[num]&mode=del&category_code_fk=$rows3[category_fk]&page=$page&l_category_fk=$rows3[l_category_fk]&ch=option2_chk&level=$level'><해제></a>");
						} 
						else {
							echo("<a href='delete1.php?p_num=$rows3[num]&mode=insert&category_code_fk=$rows3[category_fk]&page=$page&l_category_fk=$rows3[l_category_fk]&ch=option2_chk&level=$level'>등록</a>");	
						}
?>
					</td>
				</tr>
