<?
	...
	if($mode=='insert'){
		...
		$dbinsert1 = "insert into products(prod_code,category_fk,l_category_fk,name,company,cust_price,price,mileage,size,con_html,contents,s_image,s_image_ty,m_image,m_image_ty,b_image,b_image_ty,created,option1_chk,option2_chk,del_chk)
		...
		$result2 = mysql_query($query1,$connect);
		$rows1 = mysql_fetch_array($result2); //하나의 상품의 레코드를 갖는다
	...
	$dbupdate1="update products set category_fk='$category_code_fk', l_category_fk = '$l_category_fk', name = '$name', company='$company', cust_price='$cust_price', price = '$price', mileage = '$mileage', size = '$size', con_html = '$con_html',contents = '$contents' $temp1_char $temp2_char $temp3_char , option1_chk='$option1_chk', option2_chk='$option2_chk', del_chk='$del_chk' where num='$p_num'";
