...
<table width="100%" cellspacing = "0" cellpadding = "0" border="0">
			...
			<table width="100%" cellspacing = "1" cellpadding = "1" border="0" bgcolor="#999999">
				...
				<tr bgcolor="#ffffff" class="text">
					...
					<td align='center'><a href = "member_del.php?m_num=<?=$rows3[seq_num]?>&page=<?=$page?>" onclick="return confirm('삭제를 사게되면 이 회원의 모든 정보가 삭제 됩니다. 정말 삭제하시겠습니까?')">삭제</td> </a>
				</tr>
				<?
				}
			...
			<table width="100%" cellspacing = "0" cellpadding = "0" border="0">
				<tr>
					<td	height='40' align='center' class='text'>
						<?
						$url="admin_member_lists.php?id=$id&mode=$mode&jnumber=$jnumber&email=$email&phone=$phone&name=$name&mobile$mobile";
