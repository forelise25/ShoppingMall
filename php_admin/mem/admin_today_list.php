...
<table width="100%" cellspacing = "1" cellpadding = "1" border="0" bgcolor="#999999">
	...
	$query3 = "select *from member where date_format(reg_date, '%Y-%m-%d')='$time' $sear_char
	...
	<tr bgcolor="#ffffff" class="text">
		...
		<td align='center'><a href = "member_del.php?m_num=<?=$rows3[seq_num]?>&page=<?=$page?>" onclick="return confirm('삭제를 사게되면 이 회원의 모든 정보가 삭제 됩니다. 정말 삭제하시겠습니까?')">삭제</td> 
	</tr>
	<?
	}
